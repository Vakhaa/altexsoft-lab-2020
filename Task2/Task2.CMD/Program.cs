...
namespace Task2.CMD
{
    class Program
    {
        //TODO1 Сделать контроллер модели категории,
        //а дальше связать подкатегорию с внешним ключом рецепта, модель категории уже есть
        //TODO2 Сделать класс СConsoleMAnager, реализовать там всю главную логику и взаемодействие между классами
        //возможно там связать между собой подкатегории и рецепты
        // И добавить исключения в гит игнор
